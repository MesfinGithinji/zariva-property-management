              ...
              <div className="space-y-4">
                {properties.slice(0, 3).map((property, index) => (
                  <motion.a
                    ...
                    className="group flex items-center gap-4 p-4 bg-gradient-to-br from-gray-50 to-white rounded-xl border-2 border-gray-100 hover:border-gold-300 hover:shadow-lg transition-all cursor-pointer"
                  >
